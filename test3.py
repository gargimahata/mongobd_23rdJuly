...
client = pymongo.MongoClient("mongodb+srv://gargi4u:gargi4u@cluster0.meqb4he.mongodb.net/?retryWrites=true&w=majority")
db = client.test
...
#collection.update_one({'item':'canvas'},{'$set':{'item':'Gargi'}})
collection.delete_one({'item': 'Gargi'})
d = collection.find({'item': 'Gargi'})
